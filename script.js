...
function setAuthDependentUI(user) {
    ...
    if (checkoutBtn) {
        ...
        // ✅ CORREÇÃO: Lógica do Checkout (desabilitado se NÃO Logado E Tem Itens)
...
function handleSignupForm(e) {
    ...
    auth.createUserWithEmailAndPassword(email, password)
        .then((userCredential) => {
            ...
            showToast(`Registro bem-sucedido! Bem-vindo, ${email}!`, "success");
            // Adiciona o usuário recém-criado como current user
        ...
        .finally(() => {
            // ✅ SEGURANÇA: Limpa os campos de senha após a tentativa
            passwordInput.value = '';
...
function handleForgotPassword(e) {
    ...
    auth.sendPasswordResetEmail(email)
        ...
        .catch(error => {
            ...
            // Se o erro for "usuário não encontrado", as vezes é melhor dar uma msg genérica por segurança, 
            // mas aqui vamos ser explícitos para ajudar o usuário
            if (!errorMessage) {
